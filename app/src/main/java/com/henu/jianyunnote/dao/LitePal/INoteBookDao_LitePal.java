...
public interface INoteBookDao_LitePal {
    ...
    NoteBook_LitePal insert2NoteBook(String notebook_name, String bmob_objectid, Integer user_id);

    NoteBook_LitePal updateNoteBookNameById(String notebook_name, Integer notebook_id);

    NoteBook_LitePal updateNoteBookById(String notebook_id);
